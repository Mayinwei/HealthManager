...
-(void)addImageToScrollView
{
    ...
    if([[self.imageArr lastObject] isKindOfClass:[NSString class]])
    {
        ...
        isUiView=NO;
    } else if([[self.imageArr lastObject] isKindOfClass:[UIView class]])
    {
        [imgMArr insertObject:[self duplicate:(UIView *)[self.imageArr lastObject]] atIndex:0];
        [imgMArr addObject:[self duplicate:(UIView *)[self.imageArr firstObject]] ];
    }
